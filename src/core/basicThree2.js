...
export class basicThree2 {
  ...
  loadModel() {
    ...
    dracoLoader.setDecoderConfig({ type: 'wasm' }) // 使用js,wasm方式解压
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        gltf.scene.position.set(0, modelHeight/2, 0)
  ...
  // 轨道控制器 作用: 用户可以通过鼠标或触摸输入来交互式地旋转、缩放和平移3D视图
  orbitHelper() {
